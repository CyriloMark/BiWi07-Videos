(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const o of t.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function l(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function s(e){if(e.ep)return;e.ep=!0;const t=l(e);fetch(e.href,t)}})();const r="/BiWi07-Videos/assets/IMG_5500-H7IIrrqH.png",u={INTRO:{id:"INTRO",title:"Einstieg und Vorstellung",sub:"Einführung - Warum befassen wir uns mit Videobeiträgen?",href:"https://drive.google.com/file/d/15UhbZoX2ojD4bEujj1OeSnLRxRok0bhG/preview",key:"intro",icon:r,index:1},DEF:{id:"DEF",title:"Definitionen",sub:"Definitionen einer Kulturtechnik und Videobeiträgen",href:"https://www.youtube.com/watch?v=146GL3pyKDY&list=RD146GL3pyKDY&start_radio=1",key:"def",icon:r,index:2},MEANING:{id:"MEANING",title:"Bedeutung für Menschen und Lernende",sub:"Bedeutung für Schülerinnen und Schüler - Bedeutung für Jugendliche - Bedeutung für Menschen",href:"https://drive.google.com/file/d/15KewuU6LFxVzXvnJRe3ZPNB28t1tY7i6/preview",key:"meaning",icon:r,index:3},IMPLEMENTATION:{id:"IMPLEMENTATION",title:"Technische Umsetzung",sub:"Technische Umsetzung - Videobeiträge im Kontext Lernen - Einsatzmöglichkeiten - Gute vs. schlechte Lernvideos",href:"",key:"implementation",icon:r,index:4},DISCUSSION:{id:"DISCUSSION",title:"Diskussion, Pro und Contra",sub:"Vor- und Nachteile für den Unterricht - Falschinformationen - Vorgefertigte Meinungen und Identitäten - Aufmerksamkeit",href:"",key:"discussion",icon:r,index:5},OUTRO:{id:"OUTRO",title:"Fazit",sub:"Sind Videos eine neue Kulturtechnik oder eine Ergänzung?",href:"",key:"outro",icon:r,index:6}};function c(n){const i=u[n];return console.log(i.title),i}function d({data:n,key:i}){return`
        <a
            key={${i}}
            href="${n.href}"
            target="_blank"
            ...
            <div class="w-full flex flex-row justify-between drop-shadow-2xl items-center pl-5 pr-5 pt-2 pb-2 border border-black rounded-3xl bg-white">
                <div class="flex flex-row items-center>
                    ${n.icon?'<div class="w-12 aspect-square bg-amber-500"></div>':""}
                    <p
                        class={"inter-regular text-lg text-black ${n.icon?"ml-2":""}"}>
                        ${n.title}
                    </p>
                </div>
